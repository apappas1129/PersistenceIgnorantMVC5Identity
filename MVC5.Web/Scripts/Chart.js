		...
		legendCallback: function(chart) {
			...
			if (datasets.length) {
				for (var i = 0; i < datasets[0].data.length; ++i) {
				    text.push('<li style="position : relative !important; left : -100 !important; text-align: left !important;" ><span style="background-color:' + datasets[0].backgroundColor[i] + '"></span>');
					if (labels[i]) {
						text.push(labels[i]);
					}
					text.push('</li>');
		...
		global: {
			...
			legendCallback: function(chart) {
				...
				for (var i = 0; i < chart.data.datasets.length; i++) {
				    text.push('<li style="position : relative !important; left : -100 !important; text-align: left !important;" ><span style="background-color:' + chart.data.datasets[i].backgroundColor + '"></span>');
